...
def createTwoGf200ClientCmds(xmlGen,numOfPossibleSlots,frameNumbers):
    ...
    for frame in frameNumbers:
        ...
        xmlGen.addLine(1,'<client-cmd')
        xmlGen.addLine(2,'type="axon_'+str(frame)+'.twoGF200.All.Input.A" >')
        xmlGen.addLine(3,'<setTwoGf200Input engine="axon_'+str(frame)+'" >')
        for i in range(1,numOfPossibleSlots+1):
            xmlGen.addLine(3,'<setPreset engine="axon_'+str(frame)+'" preset="one" cardindex="' +str(i)+ '" />' )    
        xmlGen.addLine(3,'</setTwoGf200Input >')    
        ...
        xmlGen.addLine(1,'<client-cmd')
        xmlGen.addLine(2,'type="axon_'+str(frame)+'.twoGF200.All.Input.B" >')
        xmlGen.addLine(3,'<setTwoGf200Input engine="axon_'+str(frame)+'" >')
        for i in range(1,numOfPossibleSlots+1):
	...
	for i in range(1,numOfFrames+1)
		for j in range(1,numOfPossibleSlots+1):
			xmlGen.addLine(4,'<setPreset engine="axon_'+str(i)+'" preset="two" cardindex="' +str(j)+ '" />' )    
    xmlGen.addLine(3,'</setTwoGf200Input >')    
    xmlGen.addLine(1,'</client-cmd>')		
...
def createSigGenClientCmds(xmlGen):
    ...
    xmlGen.addLine(3,'<SigGen-Crosspoints>')
    xmlGen.addLine(4,'<setCross output="33" input="6" level="1" router="asi-router" />')
    xmlGen.addLine(4,'<setCross output="53" input="6" level="1" router="asi-router" />')
    xmlGen.addLine(3,'</SigGen-Crosspoints>')
    xmlGen.addLine(3,'</client-cmd>')
    ...
    xmlGen.addLine(3,'<SigGen-Crosspoints>')
    xmlGen.addLine(4,'<setCross output="33" input="5" level="1" router="asi-router" />')
    xmlGen.addLine(4,'<setCross output="53" input="5" level="1" router="asi-router" />')
    xmlGen.addLine(3,'</SigGen-Crosspoints>')
    xmlGen.addLine(3,'</client-cmd>')
    ...
    xmlGen.addLine(4,'<setCross output="76" input="59" level="1" router="asi-router" />')
    ...
    xmlGen.addLine(4,'<setCross output="77" input="63" level="1" router="asi-router" />')
